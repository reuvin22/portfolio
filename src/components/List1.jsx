        ...
        <div className="grid place-items center text-white bg-slate-800 w-96">
          ...
          <div className="flex justify-center align-items-center gap-x-5 my-5">
            ...
            <div className="w-full flex justify-center align-items-center gap-x-5">
                <a href={props.link}><button className='border-2 py-3 px-10 border-purple-800 rounded-2xl my-5 cursor-pointer hover:bg-purple-500'>{props.button}</button></a><a href={props.link2}><button className='border-2 py-3 px-10 border-purple-800 rounded-2xl my-5 cursor-pointer hover:bg-purple-500'>{props.button2}</button></a>
            </div>
        </div>
    </>
  )
